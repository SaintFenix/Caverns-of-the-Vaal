...
Vaal can have mountains, and mountain ranges that get quite tall, though exceedingly few will ever have snow on them. These provide additional natural barriers in a Vaal and can stretch to the very edge of the Vaal. Nearly all attempts to climb into a Galadin begin climbing a mountain towards one.

Some Vaal have collapsed in antiquity and some have Collapsed more recently, the reasons vary and this has occurred from time to time, this can destroy access to Galadin, with terrible consequences for all involved or near.
...
The Elves were the first race who lived in the Vaal, living primarily in the more forested Vaal, they roamed far through the caves and Vaal living as hunter gatherers for a time, until half decided to settle in the lighted Vaal, and the other half split into the various elves we see in the Vaal today. They are not nearly as numerous as they once were, and aren't commonly sighted outside of their primary Vaals.

Elves are always mysterious, tend towards and not away from magic, and are closer to the Galadin in spirit and knowledge than any other race. They draw their culture from the Galadin, and many of their motives feature the light of Galadin, and their worship of them.
...
Elves overwhelmingly tend to speak Elvish and common, and can sometimes speak celestial and various other primordial languages if serving in a religious capacity. Elves tending to be a closed off society, other languages tend to be much more rare.

They write in Elvish, a smooth beautiful and compact script that takes quite some time to learn well.
...
The Halflings of Siraga are much like smaller Elves, tricky and wise, they exist in far smaller numbers than even elves, and some races bunch them together as elves as well. They get along well with Elves and every so often will produce Helflings.

They have a strong mercantile culture, and resemble more the Hobbits of Middle earth, than thieves and tricksters, though those also exist in their culture. They tend to be lawful, and often live with Elves.

Halflings can be very religious, and strict, and at the same time rebellious and bold. Their civilization is marked by this divide, with some living pious Elvish like lives, and others going to cities to experience more of the world. Many other races call Halflings, small Elves.

Halfling buildings tend to look like settled Elves, and often are built by elves. Halflings will also live in dens in the ground which are generally very nicely furnished. Large buildings amongst Halflings are rare and generally town halls will be the largest building in a Halfling Village, even if the "village" has the population of a city.

Halflings have villages, but control no Vaal, there just isn't enough Halflings.

#### Halfling Languages

Halflings tend to speak Common, Elvish, or Halfling and rarely other languages, being closed off from wider Vaal society in a similar capacity to Elves. They emulate them to great degrees, which causes great divisions in their society.

Halflings write in Elvish, and the common script, and will render any of their languages in these two scripts. Transliterating when necessary and using workarounds for sounds not in a particular alphabet.

Each Halfling language has a "signed" equivalent which can be used in place of spoken speech.
...
Helflings have "signed" equivalents of each of their languages, and prefer their use over spoken speech. This leads to Helflings being considered one of the hardest races to communicate with on their own terms, as they can and will switch between languages at will between themselves.

## Technology

The Tech level of the setting varies from nomadic pre-settled populations in the case of Nomads, to a Steampunk that the Dwarves and Gnomes possess in larger cities. Technology is something that moves incredibly slowly in the Vaal, and many consider it less important than magic, as such this level of technology has been the norm for thousands of years, and shows no signs of changing.

Buildings rarely grow past two or three stories, though major constructions can get higher, or if they are built into the wall of a Vaal.

Weaponry remains high fantasy, guns and gunpowder do not exist. Magical weaponry is a very rarely created thing and as such magical weapons are generally quite rare, and many of them are quite ancient. Generally small bastions of magical crafters exist who are able to figure out the process and create these weapons, though that knowledge is exceptionally obscure and is only garnered after harsh and long study. Whole ages go without these weapons being created at all.

Ships on the Vaal seas are powered either by wind, or in rarer cases use some form of magic for propulsion. Ships tend to be large to carry enough material to provide light, as not all Vaal are lit. Drafts tend to be shallow, unless weather in the Vaal is very harsh.
